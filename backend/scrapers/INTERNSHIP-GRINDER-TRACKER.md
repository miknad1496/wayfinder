...
- MA (target: 80)
- VA (target: 80)
- MI (target: 80, current: 3 verified)
- CO (target: 80)
- AZ (target: 80)
- MN (target: 80)
- OR (target: 80)
...
## RUN LOG
- 2026-04-08 run 1: Added 20 verified CA entries (batch 2). Fields: Science (2), Healthcare (3), Law (2), Government (3), Finance (2), Arts & Media (3), Environmental Science (4), Engineering (1). Total verified CA: 25.
- 2026-04-08 run 2: Added 20 verified CA entries (batch 3). Fields: Engineering (3), Science (1), Technology (2), Healthcare (1), Law (2), Environmental Science (4), Nonprofit (3), Business (1), Education (1), Agriculture (1), Government (1), Various (1). Total verified CA: 45. DB total CA: 244.
- 2026-04-08 run 3: Added 20 verified CA entries (batch 4). Fields: Technology (3), Arts & Media (3), Science (1), Healthcare (2), Government (3), Finance (1), Education (2), Agriculture (1), Nonprofit (1), Law (1), Business (1), Various (1). Total verified CA: 79. DB total CA: 264.
...
- 2026-04-08 run 8: Added 20 verified TX entries (batch 2). Fields: Healthcare (5), Law (2), Government (2), Finance (3), Science (2), Engineering (1), Environmental Science (2), Arts & Media (1), Business (2), Nonprofit (1), Various (1). Programs: Houston Methodist HSERE, Texas Children's, UT Southwestern STARS, HBA Communities In Schools legal, Harris County Student Legal Academy, City of Austin Emerging Leaders, Dallas Works, TCU Business Innovation, TCU Investor Challenge, Texas Tech Financial Planning Academy, UT Austin HSRA, Rice PATHS-UP, HMNS Moran EcoTeen, SCA Houston Urban Green, McNay Teen Art Guide, ASPIRE Youth Entrepreneur, JFS Dallas, Dallas County DCHHS, UH Bauer Summer Institute, Houston Methodist Caring Teen. Total verified TX: 25. DB total TX: 48.
...
- 2026-04-09 run 13: Added 21 new verified TX entries (batch 9) to push TX from 79 to 100 verified (target hit ✅). Fields: Technology (3: Genesys Works Houston, Genesys Works DFW, Girlstart Teen Leader), Engineering (3: NASA JSC HSIP, TAMU E², CPS Energy), Law (2: Travis County Teen Court, HBA Summer Law), Government (3: SA Mayor's Youth, TX House Pages, TX Comptroller), Finance (1: Dallas Fed Challenge), Agriculture (1: Texas FFA), Environmental Science (2: Galveston Bay Fdn, Armand Bayou), Manufacturing (1: TXRX Labs), Education (2: SMU Gifted Students, UT Austin LCAE Bridge), Science (2: Heard Museum, TX Biomed SURE), Nonprofit (1: Houston Urban League). Focused on underrepresented fields (Manufacturing, Agriculture, Education) and geographic spread (Houston, Dallas, Austin, San Antonio, College Station, McKinney, Pasadena, Kemah). **TX TARGET HIT: 100 verified, 123 total in DB.** Next run: NY.
