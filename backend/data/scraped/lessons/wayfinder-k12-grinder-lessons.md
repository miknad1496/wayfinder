...
| 2026-04-26 | 13    | 5        | 3       | WA high offsets 96-103 (Camas SD cluster + Cape Flattery + Cascade SD). 5/5 processable verified (Camas HS, Hayes Freedom HS, Discovery HS, Neah Bay Jr/Sr HS, Cascade HS Leavenworth). 3 alt/virtual placeholders <50 skipped (Open Doors Mt Vernon enr=9, Camas SD Open Doors enr=6, Kodiak Virtual Academy enr=7). |
