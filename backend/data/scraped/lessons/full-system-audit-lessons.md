...
- last_calibration_change: 2026-05-02 — Auth pass surfaced one HIGH-impact bug (tier-gates verifyToken return-shape mismatch). Promoting "verifyToken consumer-shape audit" to a recurring sub-check across any service that consumes auth.
