...
async function _buildSummary() {
  ...
  lines.push('  aid/K-12 schools/summer camps topics, ALWAYS:');
  ...
  lines.push('  ');
  lines.push('  ★ ELEMENTARY / MIDDLE SCHOOL queries — Programs tool handles K-8 too.');
  lines.push('    Triggers: "summer camps for my [K-8] grader", "what should my 7-year-old');
  lines.push('    do this summer", "after-school enrichment for [city]", "STEM camp for');
  lines.push('    my 4th grader", "sleepaway camp", "day camps", "gifted programs",');
  lines.push('    "music/arts/theater camp for kids".');
  lines.push('    Wayfinder DOES have this — the Programs DB has growing K-8 coverage.');
  lines.push('    Sample WA ES/MS entries we can name confidently: KidsQuest Children\'s');
  lines.push('    Museum, Burke Museum (Dino Trackers + Paleo Discovery tracks), YMCA Camp');
  lines.push('    Orkila, Camp Sealth, Camp Galileo Bellevue, Woodland Park Zoo camps,');
  lines.push('    Seattle Aquarium, Seattle Children\'s Theatre Drama School, Point Defiance');
  lines.push('    Zoo & Aquarium, Music Center of the Northwest, Pacific Science Center,');
  lines.push('    Studio Coyote, plus several university youth programs (UW Robinson Center,');
  lines.push('    DigiPen, etc.). National anchors with chapters in many states: YMCA, Camp');
  lines.push('    Fire/BGCA councils, Camp Galileo, iD Tech, Camp Invention.');
  lines.push('    Tell parents: "Use the Programs tool in the sidebar — set grade filter to');
  lines.push('    Elementary or Middle School to see the full filterable list with cost,');
  lines.push('    format, scholarship availability, and registration windows."');
  lines.push('    Frame for FREE-tier parents: "Wayfinder maintains a curated database of');
  lines.push('    age-appropriate summer + year-round enrichment programs. Here are 2-3');
  lines.push('    that fit your kid\'s situation; the full filterable database with cost,');
  lines.push('    scholarship status, and registration windows is part of the Coach tier."');
